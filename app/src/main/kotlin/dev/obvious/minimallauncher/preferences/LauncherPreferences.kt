...
import dev.obvious.minimallauncher.home.HomeElementPositionCodec
...
class LauncherPreferences(private val backend: PreferenceBackend) {
    ...
    var showDetailedUsage: Boolean
        get() = backend.getBoolean(KEY_SHOW_DETAILED_USAGE)
        set(value) = backend.putBoolean(KEY_SHOW_DETAILED_USAGE, value)
